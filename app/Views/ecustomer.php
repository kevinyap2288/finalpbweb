      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?= base_url ('home/simpan_cus') ?>" method="post">   
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="tgl" placeholder="Enter No Handphone" name="hp" value="<?= $takdirestui->nohp ?>">
              </div>

             <input type="hidden" value="<?=$takdirestui->id_user?>" name="idu">
             <input type="hidden" value="<?=$takdirestui->id_customer?>" name="idc">

             <button class="btn btn-dark"><i class="fas fa-save"></i>   Edit</button>
             <a href="<?= base_url('home/hapus_customer/'.$takdirestui->id_user) ?>"
